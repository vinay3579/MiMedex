...
public class SBWEB396VerifyQDOCMessageDetailsFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB396VerifyQDOCMessageDetailsFunctionality.class);
    ...
    public void run() throws Exception {
		...
		// ########################################################################################################
		// # Test Case ID: SBWEB-396
		// # Test Case Name: VerifyQDOCMessageDetailsFunctionality
		// #-------------------------------------------------------------------------------------------------------
		// # Description: This scripts verifies that the user can sign up and reach to the QDOC Messages 
		// # landing page and verify message details functionality then successfully log out.
		// #-------------------------------------------------------------------------------------------------------
		...
		//########################################################################################################
		//Step 6 - 	Click on searched message id link on 'View QDOC Messages' page.";
		//########################################################################################################
		strStepDesc = "Click on searched message id link on 'View QDOC Messages' page.";
		strExpResult = "Message Id ("+strMessageId+") link should be clicked and 'QDOC Message Details' page should be displayed.";
		blnFlag=clickLink(strMessageId, "QDOC Message Details");
		
		if (blnFlag == true)
		{
			reporter.ReportStep(strStepDesc, strExpResult, "Message Id ("+strMessageId+") link is clicked and 'QDOC Message Details' page is displayed successfully.", "Pass");
		}
		else
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
