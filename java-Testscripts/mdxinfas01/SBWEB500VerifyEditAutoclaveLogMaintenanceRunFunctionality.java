...
public class SBWEB500VerifyEditAutoclaveLogMaintenanceRunFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB500VerifyEditAutoclaveLogMaintenanceRunFunctionality.class);
