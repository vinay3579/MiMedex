...
public class SBWEB273VerifySearchFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB273VerifySearchFunctionality.class);
    ...
    public void run() throws Exception {
		...
		// ########################################################################################################
		// # Test Case ID: SBWEB-273
		// # Test Case Name: VerifySearchFunctionality
		// #-------------------------------------------------------------------------------------------------------
		// # Description: This scripts verifies that the user can sign up and reach to the 'Donors List' landing
		// # page and search some recovery id on the page then successfully log out.
		// #-------------------------------------------------------------------------------------------------------
		// # Pre-conditions: User is logged in into the MiMedx SBWeb application.
		// # 		         User is on "Donors List" page.
		// # Post-conditions: NA
		// # Limitations: NA
		// #-------------------------------------------------------------------------------------------------------
		// # Owner: Aarti Suresh
		...
		// ########################################################################################################
		// Step 3 - Enter all the mandatory fields with
		...
		//########################################################################################################
		//Step 6 - 	Verify that if search functionality working properly in Donor List grid.
		//########################################################################################################
		...
		if (blnFlag == true)
		{
			reporter.ReportStep(strStepDesc, strExpResult, "Search functionality working properly in Donor List grid in the Recovery ID field with value '"+strRecoveryId+"'.", "Pass");
		}
		else
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
