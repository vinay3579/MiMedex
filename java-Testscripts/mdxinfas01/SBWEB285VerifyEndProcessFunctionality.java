...
public class SBWEB285VerifyEndProcessFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB285VerifyEndProcessFunctionality.class);
