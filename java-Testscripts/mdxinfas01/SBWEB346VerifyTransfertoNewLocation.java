...
public class SBWEB346VerifyTransfertoNewLocation extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB346VerifyTransfertoNewLocation.class);
