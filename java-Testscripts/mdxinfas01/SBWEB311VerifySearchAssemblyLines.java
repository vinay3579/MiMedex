...
public class SBWEB311VerifySearchAssemblyLines extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB311VerifySearchAssemblyLines.class);
    ...
    public void run() throws Exception {
		...
		// # page and search a Line Name on the page then successfully log out.
		// #-------------------------------------------------------------------------------------------------------
		...
		//########################################################################################################
		//Step 5 - 	Verify that if search functionality working properly in Assembly Lines grid.
		//########################################################################################################
		strStepDesc = "Verify search functionality working properly in Assembly Lines grid.";
		strExpResult = "Searched result should be displayed in the 'Assembly Lines' grid.";
		blnFlag=verifySearch("pgeAssemblyLines","txtSearchLineName","lnkLine", strAssemblyLine);
		if (blnFlag == true)
		{
			reporter.ReportStep(strStepDesc, strExpResult, "Search functionality working properly in Assembly Lines grid in the Line Name field with value '"+strAssemblyLine+"'.", "Pass");
		}
		else
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
