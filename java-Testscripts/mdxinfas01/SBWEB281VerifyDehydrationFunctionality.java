...
public class SBWEB281VerifyDehydrationFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB281VerifyDehydrationFunctionality.class);
    ...
    public void run() throws Exception {
		...
		//########################################################################################################
		//Step 19 -   Provide the signature in electronic signature area.
		//########################################################################################################
		strStepDesc = "Provide the signature in electronic signature area.";
		strExpResult = "The electronic signature has been provided.";		
		blnFlag = provideSignatureDehydration(strUserName,"Equipment");
		if (blnFlag == true)
		{
			reporter.ReportStep(strStepDesc, strExpResult, "The electronic signature has been input successfully.", "Pass");
		}
		else
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		//########################################################################################################
		//Step 20 -   Click on 'Add Equipment' button.
		//########################################################################################################
		...
		//########################################################################################################
		//Step 21 -   Verify if the Equipment grid has been updated with the correct values.
		//########################################################################################################
		...
		//########################################################################################################
		//Step 22 -   Click on 'No configuration specified' expansion link and verify if section expands.
		//########################################################################################################
		...
		//########################################################################################################
		//Step 23 -   Input the Sheet in the Sheet field.
		//########################################################################################################
		...
		//########################################################################################################
		//Step 24 -   Select equipment from 'Equipment' drop down list under Sheet section.
		//########################################################################################################
		...
		//########################################################################################################
		//Step 25 -   Provide the signature in electronic signature area under Sheet section.
		//########################################################################################################
		strStepDesc = "Provide the signature in electronic signature area under Sheet section.";
		strExpResult = "The electronic signature should be provided under Sheet section.";		
		blnFlag = provideSignatureDehydration(strUserName,"Sheet");
		if (blnFlag == true)
		{
			reporter.ReportStep(strStepDesc, strExpResult, "The electronic signature has been input successfully under Sheet section.", "Pass");
		}
		else
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		//########################################################################################################
		//Step 26 -   Click on 'Start Sheet' button and verify if equipment link is present in the grid.
		//########################################################################################################
		...
		//########################################################################################################
		//Step 27 -   Verify if the 'Starts and Stops' table is updated correctly.
		//########################################################################################################
		...
		blnFlag = verifyStartsStopsTable("Start", strEquipment , strFullName , strUserName);    
		if (blnFlag == true)
		{
		...
		//########################################################################################################
		//Step 28 -   Click on 'Equipment' link in the grid and verify if 'End Sheet' button is present.
		//########################################################################################################
		strStepDesc = "Click on 'Start Sheet' button and verify if equipment link is present in the grid.";
		strExpResult = "The 'Equipment' link should be clicked and the 'End Sheet' button should be verified.";		
		blnFlag = clickAndVerify("pgeProductDehydration", "lnkEquipment_Sheet", "pgeProductDehydration", "btnEndSheet");
		if (blnFlag == true)
		{
			reporter.ReportStep(strStepDesc, strExpResult, "The 'Equipment' link has been clicked successfully and the 'End Sheet' button is verified.", "Pass");
		}
		else
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		//########################################################################################################
		//Step 29 -   Provide the signature in electronic signature area under Sheet section.
		//########################################################################################################
		strStepDesc = "Provide the signature in electronic signature area under Sheet section.";
		strExpResult = "The electronic signature should be input under Sheet section.";		
		blnFlag = provideSignatureDehydration(strUserName,"Sheet");
		if (blnFlag == true)
		{
			reporter.ReportStep(strStepDesc, strExpResult, "The electronic signature has been input successfully under Sheet section.", "Pass");
		...
		//########################################################################################################
		//Step 30 -   Click on 'End Sheet' button.
		//########################################################################################################
		strStepDesc = "Click on 'End Sheet' button.";
		strExpResult = "The 'End Sheet' button should be clicked.";		
		blnFlag = Page("pgeProductDehydration").Element("btnEndSheet").Click(20);
		if (blnFlag == true)
		{
			reporter.ReportStep(strStepDesc, strExpResult, "The 'End Sheet' button has been clicked successfully.", "Pass");
		}
		else
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		//########################################################################################################
		//Step 31 -   Verify if the 'Starts and Stops' table is updated correctly.
		//########################################################################################################
		strStepDesc = "Verify if the 'Starts and Stops' table is updated correctly.";
		strExpResult = "The 'Starts and Stops' table should be updated correctly with details updated in Stop section as well.";
		blnFlag = verifyStartsStopsTable("Stop", strEquipment , strFullName , strUserName);    
		if (blnFlag == true)
		{
			reporter.ReportStep(strStepDesc, strExpResult, "The 'Starts and Stops' table is updated correctly with details updated in Stop section as well.", "Pass");
		}
		else
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		//########################################################################################################
		//Step 32 -   Click on 'No pouches specified' expansion link and verify if section expands.
		//########################################################################################################
		...
		//########################################################################################################
		//Step 33 -   Input the Lot number in the Lot # field.
		//########################################################################################################
		...
		//########################################################################################################
		//Step 34 -   Select value from the 'Equipment' dropdown under Pouches section.
		//########################################################################################################
		...
		//########################################################################################################
		//Step 35 -   Input the temperature in the Sealed At field.
		//########################################################################################################
		...
		//########################################################################################################
		//Step 36 -   Click on 'Add Pouch' button.
		//########################################################################################################
		...
		//########################################################################################################
		//Step 37 -   Verify if the 'Pouches' table is updated correctly.
		//########################################################################################################
		...
		//########################################################################################################
		//Step 38 -   Input the initial in the bottom UserID field.
		//########################################################################################################
		strStepDesc = "Input the initial in the bottom UserID field.";
		strExpResult = "The username '"+strUserName+"' should be input in the bottom Initials field.";
		blnFlag = Page("pgeProductDehydration").Element("txtSign_Bottom").Type(strUserName);
		if (blnFlag == true)
		{
			reporter.ReportStep(strStepDesc, strExpResult, "The username '"+strUserName+"' has been input successfully in the bottom Initials field.", "Pass");
		}
		else
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		// ########################################################################################################
		// Step 39 - Click on Commit button and verify if 'Print Form' link is displayed.
		// ########################################################################################################
		...
		// ########################################################################################################
		// Step 40 - Click on 'Print Form' link and verify if 'Product Dehyration Form' is opened with correct entries in it.
		// ########################################################################################################
		...
		//########################################################################################################
		//Step 41 - 	 Close the 'Print Form' PDF and validate if the PDF has been closed successfully.
		//########################################################################################################
		...
		// ########################################################################################################
		// Step 42 - Click on Return button and verify if 'Donor Tissues' page is displayed.
		// ########################################################################################################
		...
		// ########################################################################################################
		// Step 43 - Logout from SBWEB test application.
		// ########################################################################################################
