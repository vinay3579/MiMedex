...
public class SBWEB331VerifyProductInventoryLandingPage extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB331VerifyProductInventoryLandingPage.class);
    ...
    public void run() throws Exception {
		...
		// ########################################################################################################
		// # Test Case ID: SBWEB-331	
		// # Test Case Name: VerifyProductInventoryLandingPage
		// #-------------------------------------------------------------------------------------------------------
		...
		// ########################################################################################################
		// Step 4 - Click on Product Inventory link and verify 'Product Inventory' landing page is displayed.
		// ########################################################################################################
		strStepDesc = "Click on Product Inventory link and verify 'Product Inventory' landing page is displayed.";
		strExpResult = "'Product Inventory' landing page should be displayed.";
		blnFlag=clickAndVerify("pgeAssembly_Lines", "lnkProductInventory", "Product Inventory");		
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "'Product Inventory' landing page is verified successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
