...
public class SBWEB262VerifyDonorstoPackageLandingPage extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB262VerifyDonorstoPackageLandingPage.class);
