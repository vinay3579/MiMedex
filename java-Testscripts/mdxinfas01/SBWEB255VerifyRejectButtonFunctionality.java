...
public class SBWEB255VerifyRejectButtonFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB255VerifyRejectButtonFunctionality.class);
