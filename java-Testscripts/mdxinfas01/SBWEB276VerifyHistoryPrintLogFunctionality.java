...
public class SBWEB276VerifyHistoryPrintLogFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB276VerifyHistoryPrintLogFunctionality.class);
