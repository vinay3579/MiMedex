...
public class SBWEB274VerifyVariousFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB274VerifyVariousFunctionality.class);
    ...
    public void run() throws Exception {
		...
		strExpResult = "'Manufacturing Line' and 'Technician' electronic signature area should be displayed on the page.";
		blnFlag=verifyManufacturingLineTechnicianObjects();
		if (blnFlag == true)
		{
			reporter.ReportStep(strStepDesc, strExpResult, "Existence of 'Manufacturing Line' dropdown and Technician username and password text boxes is verified successfully.", "Pass");
		}
		else
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		//########################################################################################################
		//Step 18 - 	Provide Technician UserID and Password.
		//########################################################################################################
		strStepDesc = "Provide Technician UserID and Password.";
		strExpResult = "Technician Username "+strUserName+" and Password should be provided in the text boxes.";
		blnFlag=provideTechnicianSignature(strUserName, strPassword);
		if (blnFlag == true)
		{
			reporter.ReportStep(strStepDesc, strExpResult, "Technician Username "+strUserName+" and Password has been provided in the text boxes successfully.", "Pass");
		}
		else
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		//########################################################################################################
		//Step 19 - 	Click on 'Commit' button and verify new Donor Tissue page.
		//########################################################################################################
		...
		// ########################################################################################################
		// Step 20 - Push this recovery ID to the 'Common' Sheet so that it can be used for further 'Donor Processing' scripts.
		// ########################################################################################################
		...
		// ########################################################################################################
		// Step 21 - Push this Donor Key to the 'Common' Sheet so that it can be used for further 'Donor Processing' scripts.
		// ########################################################################################################
