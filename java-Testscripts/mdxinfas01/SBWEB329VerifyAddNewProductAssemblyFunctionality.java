...
public class SBWEB329VerifyAddNewProductAssemblyFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB329VerifyAddNewProductAssemblyFunctionality.class);
    ...
    public void run() throws Exception {
		...
		String strApproverUserName = Script.dicTestData.get("strApproverUserName");
		...
		//########################################################################################################
		//Step 19 - 	Enter the first UserName and sign canvas pad in 'New Assembly' Page.
		//########################################################################################################
		strStepDesc = "Enter the first UserName and sign canvas pad in 'New Assembly' Page.";
		strExpResult = "The UserName ("+strUserName+") should be entered in the first UserName and the canvas pad should be signed in 'New Assembly' Page.";
		blnFlag = provideAddAssemblySignature(strUserName); 
		if (blnFlag == true)
		{
			reporter.ReportStep(strStepDesc, strExpResult, "The UserName ("+strUserName+") is entered in the first UserName and the canvas pad is signed successfully.", "Pass");
		}
		else
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		//########################################################################################################
		//Step 20 - 	Click on 'Save' button in 'New Assembly' Page.
		//########################################################################################################
		...
		//########################################################################################################
		//Step 21 - 	Enter the second UserName and sign canvas pad in 'New Assembly' Page.
		//########################################################################################################
		strStepDesc = "Enter the second UserName and sign canvas pad in 'New Assembly' Page.";
		strExpResult = "The UserName ("+strApproverUserName+") should be entered in the second UserName and the canvas pad should be signed in 'New Assembly' Page.";
		blnFlag = provideAddAssemblySignature(strApproverUserName); 
		if (blnFlag == true)
		{
			reporter.ReportStep(strStepDesc, strExpResult, "The UserName ("+strApproverUserName+") is entered in the second UserName and the canvas pad is signed successfully.", "Pass");
		}
		else
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		// ########################################################################################################
		// Step 22 - Click on 'Save' button and verify 'Unlock' button is displayed.
		// ########################################################################################################
		...
		// ########################################################################################################
		// Step 23 - Click on 'Return' button and verify navigated page.
		// ########################################################################################################
		...
		//########################################################################################################
		//Step 24 - 	Verify that the newly added Product Assembly can be accessed in the Product Assembly grid.
		//########################################################################################################
