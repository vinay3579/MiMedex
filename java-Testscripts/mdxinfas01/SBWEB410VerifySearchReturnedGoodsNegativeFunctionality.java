...
public class SBWEB410VerifySearchReturnedGoodsNegativeFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB410VerifySearchReturnedGoodsNegativeFunctionality.class);
    ...
    public void run() throws Exception {
		...
		// ########################################################################################################
		// # Test Case ID: SBWEB-410
		// # Test Case Name: VerifyReturnedGoodsNegativeFunctionality
		// #-------------------------------------------------------------------------------------------------------
		// # Description: This script verifies 'Returned Goods' negative functionality in 'Orders' page
		...
		blnFlag = clickAndVerifyVisible("pgeAssembly_Lines", "lnkOrders", "pgeAssembly_Lines", "lnkReturnedGoods");
		...
		// ########################################################################################################
		// Step 4 - Click on 'Returned Goods' link and verify 'Returned Goods' page.
		// ########################################################################################################
		...
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "'Returned Goods' link is clicked and 'Returned Goods' page is verified successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		// ########################################################################################################
		// Step 5 - Enter some invalid/junk characters in the 'RGA #' search box and verify displayed message. 
		// ########################################################################################################
		strStepDesc = "Enter some invalid/junk characters in the 'RGA #' search box.";
		strExpResult = "Invalid/junk characters should be entered in the 'RGA #' search box and '" + strExpectedText + "' message should be displayed.";
		blnFlag = verifySearchResults("pgeReturnedGoods", "RGA #", strSearchText, "pgeCommon", "objNoRecordsFound", strExpectedText);
		
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "Invalid/junk characters are entered in the 'RGA #' search box and '" + strExpectedText + "' message is displayed successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		// ########################################################################################################
		// Step 6 - Clear 'RGA #' search box and verify page refresh. 
		// ########################################################################################################
		strStepDesc = "Clear 'RGA #' search box and verify page refresh.";
		strExpResult = "'RGA #' search box should be cleared and the page should be refreshed.";
		blnFlag = clearSearchField("pgeReturnedGoods", "RGA #");
		
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "'RGA #' search box is cleared and the page is refreshed.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		// ########################################################################################################
		// Step 7 - Enter some invalid/junk characters in the 'Customer' search box and verify displayed message. 
		// ########################################################################################################
		...
		blnFlag = verifySearchResults("pgeReturnedGoods", "Customer", strSearchText, "pgeCommon", "objNoRecordsFound", strExpectedText);
		...
		// ########################################################################################################
		// Step 8 - Clear 'Customer' search box and verify page refresh. 
		// ########################################################################################################
		...
		blnFlag = clearSearchField("pgeReturnedGoods", "Customer");
		...
		// ########################################################################################################
		// Step 9 - Enter some invalid/junk characters in the 'Return Reason' search box and verify displayed message. 
		// ########################################################################################################
		strStepDesc = "Enter some invalid/junk characters in the 'Return Reason' search box.";
		strExpResult = "Invalid/junk characters should be entered in the 'Return Reason' search box and '" + strExpectedText + "' message should be displayed.";
		blnFlag = verifySearchResults("pgeReturnedGoods", "Return Reason", strSearchText, "pgeCommon", "objNoRecordsFound", strExpectedText);
		
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "Invalid/junk characters are entered in the 'Return Reason' search box and '" + strExpectedText + "' message is displayed successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		// ########################################################################################################
		// Step 10 - Clear 'Return Reason' search box and verify page refresh. 
		// ########################################################################################################
		strStepDesc = "Clear 'Return Reason' search box and verify page refresh.";
		strExpResult = "'Return Reason' search box should be cleared and the page should be refreshed.";
		blnFlag = clearSearchField("pgeReturnedGoods", "Return Reason");
		
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "'Return Reason' search box is cleared and the page is refreshed.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
