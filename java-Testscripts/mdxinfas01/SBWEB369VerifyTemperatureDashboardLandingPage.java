...
public class SBWEB369VerifyTemperatureDashboardLandingPage extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB369VerifyTemperatureDashboardLandingPage.class);
    ...
    public void run() throws Exception {
		...
		// ########################################################################################################
		// # Test Case ID: SBWEB-369
		// # Test Case Name: VerifyTemperature DashboardLandingPage
		// #-------------------------------------------------------------------------------------------------------
		...
		blnFlag=clickAndVerifyVisible("pgeAssembly_Lines", "lnkRecovery", "pgeAssembly_Lines", "lnkTemperatureDashboard");
		...
		// ########################################################################################################
		// Step 4 - Click on 'Temperature Dashboard' link and verify landing page.
		// ########################################################################################################
		strStepDesc = "Click on 'Temperature Dashboard' link and verify 'Temperature Dashboard' landing page is displayed.";
		strExpResult = "'Temperature Dashboard' landing page should be displayed.";
		blnFlag=clickAndVerify("pgeAssembly_Lines","lnkTemperatureDashboard", "Temperature Dashboard");
		
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, " 'Temperature Dashboard' link is clicked and 'Temperature Dashboard' landing page is verified successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
