...
public class SBWEB257VerifyEligibilityLinkFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB257VerifyEligibilityLinkFunctionality.class);
    ...
    public void run() throws Exception {
		...
		blnFlag=fillEntriesForEligible(strEligibleComment, strUserName, strPassword);
