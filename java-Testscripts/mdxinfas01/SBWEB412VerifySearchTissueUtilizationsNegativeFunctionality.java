...
public class SBWEB412VerifySearchTissueUtilizationsNegativeFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB412VerifySearchTissueUtilizationsNegativeFunctionality.class);
    ...
    public void run() throws Exception {
		...
		// # Test Case Name: VerifyTissueUtilizationsNegativeFunctionality
		// #-------------------------------------------------------------------------------------------------------
		...
		// ########################################################################################################
		// Step 5 - Enter some invalid/junk characters in the 'Tissue' search box and verify displayed message. 
		// ########################################################################################################
		...
		blnFlag = verifySearchResults("pgeTissueUtilization", "Tissue", strSearchText, "pgeCommon", "objNoRecordsFound", strExpectedText);
		...
		// ########################################################################################################
		// Step 6 - Clear 'Tissue' search box and verify page refresh. 
		// ########################################################################################################
		...
		// ########################################################################################################
		// Step 7 - Enter some invalid/junk characters in the 'Distributor' search box and verify displayed message. 
		// ########################################################################################################
		strStepDesc = "Enter some invalid/junk characters in the 'Distributor' search box.";
		strExpResult = "Invalid/junk characters should be entered in the 'Distributor' search box and '" + strExpectedText + "' message should be displayed.";
		blnFlag = verifySearchResults("pgeTissueUtilization", "Distributor", strSearchText, "pgeCommon", "objNoRecordsFound", strExpectedText);
		
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "Invalid/junk characters are entered in the 'Distributor' search box and '" + strExpectedText + "' message is displayed successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		// ########################################################################################################
		// Step 8 - Clear 'Distributor' search box and verify page refresh. 
		// ########################################################################################################
		strStepDesc = "Clear 'Distributor' search box and verify page refresh.";
		strExpResult = "'Distributor' search box should be cleared and the page should be refreshed.";
		...
		// ########################################################################################################
		// Step 9 - Enter some invalid/junk characters in the 'Facility' search box and verify displayed message. 
		// ########################################################################################################
		...
		blnFlag = verifySearchResults("pgeTissueUtilization", "Facility", strSearchText, "pgeCommon", "objNoRecordsFound", strExpectedText);
		...
		// ########################################################################################################
		// Step 10 - Clear 'Facility' search box and verify page refresh. 
		// ########################################################################################################
		...
		// ########################################################################################################
		// Step 11 - Enter some invalid/junk characters in the 'Surgeon Last Name' search box and verify displayed message. 
		// ########################################################################################################
		strStepDesc = "Enter some invalid/junk characters in the 'Surgeon Last Name' search box.";
		strExpResult = "Invalid/junk characters should be entered in the 'Surgeon Last Name' search box and '" + strExpectedText + "' message should be displayed.";
		blnFlag = verifySearchResults("pgeTissueUtilization", "Surgeon Last Name", strSearchText, "pgeCommon", "objNoRecordsFound", strExpectedText);
		
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "Invalid/junk characters are entered in the 'Surgeon Last Name' search box and '" + strExpectedText + "' message is displayed successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		// ########################################################################################################
		// Step 12 - Clear 'Surgeon Last Name' search box and verify page refresh. 
		// ########################################################################################################
		strStepDesc = "Clear 'Surgeon Last Name' search box and verify page refresh.";
		strExpResult = "'Surgeon Last Name' search box should be cleared and the page should be refreshed.";
		...
		// ########################################################################################################
		// Step 13 - Enter some invalid/junk characters in the 'Patient Last' search box and verify displayed message. 
		// ########################################################################################################
		strStepDesc = "Enter some invalid/junk characters in the 'Patient Last' search box.";
		...
		blnFlag = verifySearchResults("pgeTissueUtilization", "Patient Last", strSearchText, "pgeCommon", "objNoRecordsFound", strExpectedText);
		...
		// ########################################################################################################
		// Step 14 - Clear 'Patient Last' search box and verify page refresh. 
		// ########################################################################################################
		strStepDesc = "Clear 'Patient Last' search box and verify page refresh.";
		strExpResult = "'Patient Last' search box should be cleared and the page should be refreshed.";
		...
		// ########################################################################################################
		// Step 15 - Enter some invalid/junk characters in the 'Procedure Date' search box and verify displayed message. 
		// ########################################################################################################
		strStepDesc = "Enter some invalid/junk characters in the 'Procedure Date' search box.";
		strExpResult = "Invalid/junk characters should be entered in the 'Procedure Date' search box and '" + strExpectedText + "' message should be displayed.";
		blnFlag = verifySearchResults("pgeTissueUtilization", "Procedure Date", strSearchText, "pgeCommon", "objNoRecordsFound", strExpectedText);
		
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "Invalid/junk characters are entered in the 'Procedure Date' search box and '" + strExpectedText + "' message is displayed successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		// ########################################################################################################
		// Step 16 - Clear 'Procedure Date' search box and verify page refresh. 
		// ########################################################################################################
		strStepDesc = "Clear 'Procedure Date' search box and verify page refresh.";
		strExpResult = "'Procedure Date' search box should be cleared and the page should be refreshed.";
		...
		// ########################################################################################################
		// Step 17 - Enter some invalid/junk characters in the 'Procedure Type' search box and verify displayed message. 
		// ########################################################################################################
		strStepDesc = "Enter some invalid/junk characters in the 'Procedure Type' search box.";
		strExpResult = "Invalid/junk characters should be entered in the 'Procedure Type' search box and '" + strExpectedText + "' message should be displayed.";
		blnFlag = verifySearchResults("pgeTissueUtilization", "Procedure Type", strSearchText, "pgeCommon", "objNoRecordsFound", strExpectedText);
		
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "Invalid/junk characters are entered in the 'Procedure Type' search box and '" + strExpectedText + "' message is displayed successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		// ########################################################################################################
		// Step 18 - Clear 'Procedure Type' search box and verify page refresh. 
		// ########################################################################################################
		strStepDesc = "Clear 'Procedure Type' search box and verify page refresh.";
		strExpResult = "'Procedure Type' search box should be cleared and the page should be refreshed.";
		...
		// ########################################################################################################
		// Step 19 - Enter some invalid/junk characters in the 'Posting Date' search box and verify displayed message. 
		// ########################################################################################################
		strStepDesc = "Enter some invalid/junk characters in the 'Posting Date' search box.";
		strExpResult = "Invalid/junk characters should be entered in the 'Posting Date' search box and '" + strExpectedText + "' message should be displayed.";
		blnFlag = verifySearchResults("pgeTissueUtilization", "Posting Date", strSearchText, "pgeCommon", "objNoRecordsFound", strExpectedText);
		
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "Invalid/junk characters are entered in the 'Posting Date' search box and '" + strExpectedText + "' message is displayed successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		// ########################################################################################################
		// Step 20 - Clear 'Posting Date' search box and verify page refresh. 
		// ########################################################################################################
		strStepDesc = "Clear 'Posting Date' search box and verify page refresh.";
		strExpResult = "'Posting Date' search box should be cleared and the page should be refreshed.";
		...
		// ########################################################################################################
		// Step 21 - Enter some invalid/junk characters in the 'Updated By' search box and verify displayed message. 
		// ########################################################################################################
		strStepDesc = "Enter some invalid/junk characters in the 'Updated By' search box.";
		...
		blnFlag = verifySearchResults("pgeTissueUtilization", "Updated By", strSearchText, "pgeCommon", "objNoRecordsFound", strExpectedText);
		...
		// ########################################################################################################
		// Step 22 - Clear 'Updated By' search box and verify page refresh. 
		// ########################################################################################################
		...
		// ########################################################################################################
		// Step 23 - Enter some invalid/junk characters in the 'Pending' search box and verify displayed message. 
		// ########################################################################################################
		strStepDesc = "Enter some invalid/junk characters in the 'Pending' search box.";
		strExpResult = "Invalid/junk characters should be entered in the 'Pending' search box and '" + strExpectedText + "' message should be displayed.";
		blnFlag = verifySearchResults("pgeTissueUtilization", "Pending", strSearchText, "pgeCommon", "objNoRecordsFound", strExpectedText);
		
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "Invalid/junk characters are entered in the 'Pending' search box and '" + strExpectedText + "' message is displayed successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		// ########################################################################################################
		// Step 24 - Clear 'Pending' search box and verify page refresh. 
		// ########################################################################################################
		strStepDesc = "Clear 'Pending' search box and verify page refresh.";
		strExpResult = "'Pending' search box should be cleared and the page should be refreshed.";
