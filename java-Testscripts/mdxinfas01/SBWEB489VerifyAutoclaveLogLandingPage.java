...
public class SBWEB489VerifyAutoclaveLogLandingPage extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB489VerifyAutoclaveLogLandingPage.class);
    ...
    public void run() throws Exception {
		...
		// ########################################################################################################
		// # Test Case ID: SBWEB-489
		// # Test Case Name: VerifyAutoclaveLogLandingPage
		// #-------------------------------------------------------------------------------------------------------
		// # Description: This scripts verifies that the user can sign up and reach to the Autoclave Log 
		...
		// ########################################################################################################
		// Step 4 - Click on 'Autoclave Log' link and verify landing page.
		// ########################################################################################################
		strStepDesc = "Click on 'Autoclave Log' link and verify 'Autoclave Log' landing page is displayed.";
		strExpResult = "'Autoclave Log' landing page should be displayed.";
		blnFlag=clickAndVerify("pgeAssembly_Lines","lnkAutoclaveLog", "Autoclave Log");
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "'Autoclave Log' link is clicked and 'Autoclave Log' landing page is verified successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
