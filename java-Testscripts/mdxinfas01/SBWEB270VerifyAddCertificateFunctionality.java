...
public class SBWEB270VerifyAddCertificateFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB270VerifyAddCertificateFunctionality.class);
    ...
    public void run() throws Exception {
		...
		//########################################################################################################
		//Step 9 - 	Click 'Commit' button on 'Edit Certificate of Conformance' page. 
		//########################################################################################################
		strStepDesc = "Click 'Commit' button on 'Edit Certificate of Conformance' page.";
		strExpResult = "Certificate should be committed.";
		blnFlag=commitCertificate(strUserName,strPassword);
		...
		// ########################################################################################################
		// Step 10 - Push this donor key to the 'Common' Sheet so that it can be used for further 'Certificate of Conformance' scripts.
		// ########################################################################################################
		strStepDesc = "Push this 'Donor Key' to the 'Common' Sheet so that it can be used for further 'Certificate of Conformance' scripts.";
		strExpResult = "Donor Key '"+strDonorKey+"' should be pushed to the Common datasheet under 'strDonorKey_CertificateofConformance' for further use.";
		blnFlag = sendValuetoCommonSheet("strDonorKey_CertificateofConformance",strDonorKey);
		if (blnFlag == true) 
		{			
			reporter.ReportStep(strStepDesc, strExpResult, "Donor Key '"+strDonorKey+"' is pushed successfully to the Common datasheet under 'strDonorKey_CertificateofConformance' for further use.","Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
