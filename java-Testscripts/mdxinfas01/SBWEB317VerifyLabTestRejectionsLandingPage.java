...
public class SBWEB317VerifyLabTestRejectionsLandingPage extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB317VerifyLabTestRejectionsLandingPage.class);
    ...
    public void run() throws Exception {
		...
		// ########################################################################################################
		// # Test Case ID: SBWEB-317
		// # Test Case Name: VerifyLabTestRejectionsLandingPage
		// #-------------------------------------------------------------------------------------------------------
		...
		// ########################################################################################################
		// Step 4 - Click on 'Lab Test Rejections' link and verify landing page.
		// ########################################################################################################
		strStepDesc = "Click on 'Lab Test Rejections' link and verify 'Lab Test Rejections' landing page is displayed.";
		strExpResult = "'Lab Test Rejections' landing page should be verified successfully.";
		blnFlag=clickAndVerify("pgeAssembly_Lines","lnkLabTestRejections", "Lab Test Rejections");
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "'Lab Test Rejections' link is clicked and 'Lab Test Rejections' landing page is verified successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
