...
public class SBWEB328VerifySearchProductAssembly extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB328VerifySearchProductAssembly.class);
