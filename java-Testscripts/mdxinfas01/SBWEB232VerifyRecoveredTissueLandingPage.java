...
public class SBWEB232VerifyRecoveredTissueLandingPage extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB232VerifyRecoveredTissueLandingPage.class);
    ...
    public void run() throws Exception {
		...
		// ########################################################################################################
		// Step 4 - Click on 'Recovered Tissue' link and verify landing page.
		// ########################################################################################################
		strStepDesc = "Click on 'Recovered Tissue' link and verify 'Recovered Tissue' landing page is displayed.";
		strExpResult = "'Recovered Tissue' landing page should be displayed.";
		blnFlag=clickAndVerify("pgeAssembly_Lines","lnkRecovered_Tissue", "Recovered Tissue");
		
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, " 'Recovered Tissue' link is clicked and 'Recovered Tissue' landing page is verified successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
