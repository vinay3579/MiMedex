...
public class SBWEB261VerifyCommitButtonFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB261VerifyCommitButtonFunctionality.class);
