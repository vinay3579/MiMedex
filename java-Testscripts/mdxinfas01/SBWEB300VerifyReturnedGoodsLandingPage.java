...
public class SBWEB300VerifyReturnedGoodsLandingPage extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB300VerifyReturnedGoodsLandingPage.class);
    ...
    public void run() throws Exception {
		...
		// ########################################################################################################
		// # Test Case ID: SBWEB-300
		// # Test Case Name: VerifyReturnedGoodsLandingPage
		// #-------------------------------------------------------------------------------------------------------
		...
		// ########################################################################################################
		// Step 4 - Click on 'Returned Goods' link and verify landing page.
		// ########################################################################################################
		strStepDesc = "Click on 'Returned Goods' link and verify 'Returned Goods' landing page is displayed.";
		strExpResult = "'Returned Goods' landing page should be displayed.";
		blnFlag=clickAndVerify("pgeAssembly_Lines","lnkReturnedGoods", "Returned Goods");
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "'Returned Goods' link is clicked and 'Returned Goods' landing page is verified successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
