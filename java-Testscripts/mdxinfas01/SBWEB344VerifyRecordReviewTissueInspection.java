...
public class SBWEB344VerifyRecordReviewTissueInspection extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB344VerifyRecordReviewTissueInspection.class);
    ...
    public void run() throws Exception {
		...
		// ########################################################################################################
		// # Test Case ID: SBWEB-344
		// # Test Case Name: VerifyRecordReviewTissueInspection
		// #-------------------------------------------------------------------------------------------------------
		// # Description: This scripts verifies that the user can sign up and reach to the 'Packaged Donors' landing
		// # page , perform Record and Review Tissue Inspection on a tissue and then log out.
		// #-------------------------------------------------------------------------------------------------------
		...
		blnFlag = clickAndVerify("pgePackagedDonors", "lnkDonor", "pgeAddTissue","btnRecordReviewTissueInspection");		
		if (blnFlag == true) 
		{			
		...
		if (blnFlag == true) 
		{			
			reporter.ReportStep(strStepDesc, strExpResult, "'Record/Review Tissue Inspection' button is clicked and the navigated page is verified successfully.","Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
