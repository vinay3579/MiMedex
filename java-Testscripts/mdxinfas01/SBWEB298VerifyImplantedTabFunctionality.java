...
public class SBWEB298VerifyImplantedTabFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB298VerifyImplantedTabFunctionality.class);
