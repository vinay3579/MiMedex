...
public class SBWEB316VerifyDeleteTestComplianceFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB316VerifyDeleteTestComplianceFunctionality.class);
