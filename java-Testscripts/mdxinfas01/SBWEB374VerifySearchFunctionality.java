...
public class SBWEB374VerifySearchFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB374VerifySearchFunctionality.class);
