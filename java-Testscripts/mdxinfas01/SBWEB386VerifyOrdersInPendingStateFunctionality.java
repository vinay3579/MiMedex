...
public class SBWEB386VerifyOrdersInPendingStateFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB386VerifyOrdersInPendingStateFunctionality.class);
    ...
    public void run() throws Exception {
		...
		strExpResult = "Tissue '"+strTissueId+"' should be moved and displayed under 'Selected Tissues' grid.";
