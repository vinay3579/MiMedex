...
public class SBWEB259VerifyDonorstoPackageLandingPage extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB259VerifyDonorstoPackageLandingPage.class);
