...
public class SBWEB296VerifyAgentRefreshFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB296VerifyAgentRefreshFunctionality.class);
