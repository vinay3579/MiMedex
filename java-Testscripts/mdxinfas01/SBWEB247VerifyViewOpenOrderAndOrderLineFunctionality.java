...
public class SBWEB247VerifyViewOpenOrderAndOrderLineFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB247VerifyViewOpenOrderAndOrderLineFunctionality.class);
