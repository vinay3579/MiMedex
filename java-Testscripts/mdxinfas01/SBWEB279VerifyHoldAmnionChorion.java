...
public class SBWEB279VerifyHoldAmnionChorion extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB279VerifyHoldAmnionChorion.class);
    ...
    public void run() throws Exception {
		...
		// ########################################################################################################
		// # Test Case ID: SBWEB-279
		// # Test Case Name: VerifyHoldAmnionChorion
		// #-------------------------------------------------------------------------------------------------------
		// # Description: This scripts verifies 'Hold Amnion' and 'Hold Chorion' button functionality on "Donor Tissues" page.
		// # ------------------------------------------------------------------------------------------------------
		...
		//########################################################################################################
		//Step 7 - 	Click on 'Hold Amnion' button and verify popup.
		//########################################################################################################
		strStepDesc = "Click on 'Hold Amnion' button and verify popup.";
		strExpResult = "The 'Hold Amnion' button should be clicked and popup should be displayed.";		
		blnFlag=clickAndVerifyVisible("pgeDonorProcessing", "btnHoldAmnion", "pgeDonorProcessing", "lstRefrigerator");
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "The 'Hold Amnion' button is clicked and popup display is verified successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		//########################################################################################################
		strStepDesc = "The 'Hold Amnion' popup should be filled with valid values.";
		strExpResult = "The 'Hold Amnion' popup should be filled with valid values.";		
		blnFlag=fillAmnionChorionPopup(strRefrigerator, strUserName, strPassword);
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "The 'Hold Amnion' popup is successfully filled with valid values.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		//########################################################################################################
		//Step 9 - 	Click on 'Commit' button and verify presence of 'Release Amnion' button.
		//########################################################################################################
		strStepDesc = "Click on 'Commit' button and verify presence of 'Release Amnion' button.";
		strExpResult = "'Commit' button should be clicked and 'Release Amnion' button should be verified.";		
		blnFlag=clickAndVerifyVisible("pgeDonorProcessing", "btnCommit", "pgeDonorProcessing", "btnReleaseAmnion");
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "'Commit' button is clicked and 'Release Amnion' button is verified successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		blnFlag=verifyHoldReleaseRefrigeratorLog("Amnion", "Hold", strRecoveryId, strRefrigerator, strFullName);
		if (blnFlag == true) 
		{
		...
		//########################################################################################################
		//Step 11 - 	Click on 'Hold Chorion' button and verify popup.
		//########################################################################################################
		strStepDesc = "Click on 'Hold Chorion' button and verify popup.";
		strExpResult = "'Hold Chorion' button should be clicked and popup should be displayed.";		
		blnFlag=clickAndVerifyVisible("pgeDonorProcessing", "btnHoldChorion", "pgeDonorProcessing", "lstRefrigerator");
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "The 'Hold Chorion' button is clicked and popup display is verified successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		//########################################################################################################
		//Step 12 - 	Fill all valid values in the 'Hold Chorion' popup.
		//########################################################################################################
		strStepDesc = "The 'Hold Chorion' popup should be filled with valid values.";
		strExpResult = "The 'Hold Chorion' popup should be filled with valid values.";		
		blnFlag=fillAmnionChorionPopup(strRefrigerator, strUserName, strPassword);
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "The 'Hold Chorion' popup is filled successfully with valid values.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		//########################################################################################################
		//Step 13 - 	Click on 'Commit' button and verify presence of 'Release Chorion' button.
		//########################################################################################################
		strStepDesc = "Click on 'Commit' button and verify presence of 'Release Chorion' button.";
		strExpResult = "'Commit' button should be clicked and 'Release Chorion' button should be verified.";		
		blnFlag=clickAndVerifyVisible("pgeDonorProcessing", "btnCommit", "pgeDonorProcessing", "btnReleaseChorion");
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "'Commit' button is clicked and 'Release Chorion' button is verified successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		strExpResult = "The refrigerator log should be updated with values entered.";		
		blnFlag=verifyHoldReleaseRefrigeratorLog("Chorion", "Hold", strRecoveryId, strRefrigerator, strFullName);
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "The updates on the refrigerator log have been verified successfully.", "Pass");
		}
