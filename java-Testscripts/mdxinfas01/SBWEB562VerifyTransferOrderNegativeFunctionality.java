...
public class SBWEB562VerifyTransferOrderNegativeFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB562VerifyTransferOrderNegativeFunctionality.class);
...
/*
		...
		blnFlag=verifyErrorMessage("pgeSalesOrder", "txtShipTo", "", "btnSave", strErrorText);
		if (blnFlag == true)
		{
		...
		blnFlag=verifyErrorMessage("pgeSalesOrder", "txtTransferDate", strInvalidDate, "btnSave", strExpectedText);
		if (blnFlag == true)
		{
