...
public class SBWEB256VerifySaveButtonFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB256VerifySaveButtonFunctionality.class);
    ...
    public void run() throws Exception {
		...
		// # Test Case Name: VerifySaveButtonFunctionality
		// #------------------------------------------------------------------------------------------------------
		// # Description: This scripts verifies save button functionality on 'Recovered Tissue' page under 'Eligibility Review'
		...
		String strQAComment = Script.dicTestData.get("strQAComment");
		...
		//########################################################################################################
		//Step 7 - 	Verify save button functionality on Recovered Tissue page. 
		//########################################################################################################
		strStepDesc = "Verify 'Save' button functionality on 'Recovered Tissue' page.";
		strExpResult = "QA notes should be saved on 'Recovered Tissue' page.";
		blnFlag=verifySaveFunctionality(strQAComment);
		
		if (blnFlag == true)
		{
			reporter.ReportStep(strStepDesc, strExpResult, "QA notes saved successfully on 'Recovered Tissue' page.", "Pass");
		}
		else
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
