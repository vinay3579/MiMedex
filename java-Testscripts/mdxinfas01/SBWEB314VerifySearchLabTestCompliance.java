...
public class SBWEB314VerifySearchLabTestCompliance extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB314VerifySearchLabTestCompliance.class);
    ...
    public void run() throws Exception {
		...
		// ########################################################################################################
		// # Test Case ID: SBWEB-314
		// # Test Case Name: VerifySearchLabTestCompliance
		// #-------------------------------------------------------------------------------------------------------
		// # Description: This scripts verifies that the user can sign up and reach to the Lab Test Compliance
		// # landing page, search for a Test Name and then successfully log out.
		// #-------------------------------------------------------------------------------------------------------
