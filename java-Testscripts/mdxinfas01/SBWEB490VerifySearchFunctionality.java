...
public class SBWEB490VerifySearchFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB490VerifySearchFunctionality.class);
