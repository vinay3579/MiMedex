...
public class SBWEB265VerifyPackagingInspectionLandingPage extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB265VerifyPackagingInspectionLandingPage.class);
    ...
    public void run() throws Exception {
		...
		// ########################################################################################################
		// # Test Case ID: SBWEB-265
		// # Test Case Name: VerifyPackagingInspectionLandingPage
		// #-------------------------------------------------------------------------------------------------------
		// # Description: This scripts verifies that a the user can sign in and land on the "Package Inspection" landing page and then successfully log out.
		// #-------------------------------------------------------------------------------------------------------
		...
		// ########################################################################################################
		// Step 4 - Click on 'Packaging Inspection' link and verify 'Packaging Inspection' landing page is displayed.
		// ########################################################################################################
		strStepDesc = "Click on 'Packaging Inspection' link and verify 'Packaging Inspection' landing page is displayed.";
		strExpResult = "'Packaging Inspection' landing page should be verified.";
		blnFlag=clickAndVerify("pgeAssembly_Lines", "lnkPackagingInspection", "Packaging Inspection");		
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "'Package Inspection' link is clicked and 'Packaging Inspection' landing page is verified successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
