...
public class SBWEB327VerifyProductAssemblyLandingPage extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB327VerifyProductAssemblyLandingPage.class);
    ...
    public void run() throws Exception {
		...
		// ########################################################################################################
		// # Test Case ID: SBWEB-327
		// # Test Case Name: VerifyProductAssemblyLandingPage
		// #-------------------------------------------------------------------------------------------------------
		// # Description: This scripts verifies that a the user can sign in and land on the "Product Assembly" landing page and then successfully log out.
		// #-------------------------------------------------------------------------------------------------------
		...
		// ########################################################################################################
		// Step 4 - Click on 'Product Assembly' link and verify 'Product Assembly' landing page is displayed.
		// ########################################################################################################
		strStepDesc = "Click on 'Product Assembly' link and verify 'Product Assembly' landing page is displayed.";
		strExpResult = "'Product Assembly' landing page should be displayed.";
		blnFlag=clickAndVerify("pgeAssembly_Lines", "lnkProductAssembly", "Product Assembly");		
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "'Product Assembly' link is clicked and 'Product Assembly' landing page is verified successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
