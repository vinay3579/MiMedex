...
public class SBWEB299VerifyConsignmentBillingFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB299VerifyConsignmentBillingFunctionality.class);
    ...
    public void run() throws Exception {
		...
		strExpResult = "Purchase order: '"+strPurchaseOrder+"' should be filled in 'Purchase Order' field.";
		...
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "Tissue moved from 'Available Tissues' grid and displayed under 'Selected Tissues' grid.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
