...
public class SBWEB284VerifyVIFormPrintLogFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB284VerifyVIFormPrintLogFunctionality.class);
    ...
    public void run() throws Exception {
		...
		// ########################################################################################################
		// # Test Case ID: SBWEB-284
		// # Test Case Name: VerifyVIFormPrintLogFunctionality
		// #-------------------------------------------------------------------------------------------------------
		// # Description: This scripts verifies 'VI Form' and 'Print Log' link functionality on 'Donor Tissues' page.
		// #-------------------------------------------------------------------------------------------------------
		...
		String strVIFormExpectedText = Script.dicTestData.get("strVIFormExpectedText");
		...
		//########################################################################################################
		//Step 7 - 	 Verify the 'Print Log' functionality on 'Donor Tissues' page.
		//########################################################################################################
		...
		//########################################################################################################
		//Step 8 - 	 Close the 'Print Log' PDF and validate if the PDF has been closed successfully.
		//########################################################################################################
		...
		//########################################################################################################
		//Step 9 - 	 Verify the 'VI Form' functionality on 'Donor Tissues' page.
		//########################################################################################################
		strStepDesc = "Verify the 'VI Form' functionality on 'Donor Tissues' page.";
		strExpResult = "'VI Form' PDF should be verified for the keywords '"+strDonorKey+","+strVIFormExpectedText+"'.";
		blnFlag=clickVIForm(strDonorKey, strVIFormExpectedText);
		if (blnFlag == true)
		{
			reporter.ReportStep(strStepDesc, strExpResult, "'VI Form' link has been clicked and the PDF has been verified for the keywords '"+strDonorKey+","+strVIFormExpectedText+"'.", "Pass");
		}
		else
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		//########################################################################################################
		//Step 10 - 	 Close the 'VI Form' PDF and validate if the PDF has been closed successfully.
		//########################################################################################################
		strStepDesc = "Close the 'VI Form' PDF and validate if the PDF has been closed successfully.";
		strExpResult = "'VI Form' PDF should be closed successfully.";
		blnFlag=closePDF("Donor Tissues");
		if (blnFlag == true)
		{
			reporter.ReportStep(strStepDesc, strExpResult, "'VI Form' PDF has been closed successfully and the navigated page has been verified for the title 'Donor Tissues'.", "Pass");
		}
		else
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
