...
public class SBWEB253VerifyEligibilityReviewLandingPage extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB253VerifyEligibilityReviewLandingPage.class);
    ...
    public void run() throws Exception {
		...
		// ########################################################################################################
		// Step 4 - Click on 'Eligibility Review' link and verify 'Release Processing' landing page.
		// ########################################################################################################
		strStepDesc = "Click on 'Eligibility Review' link and verify 'Release Processing' landing page is displayed.";
		strExpResult = "'Release Processing' landing page should be displayed.";
		blnFlag=clickAndVerify("pgeAssembly_Lines","lnkEligibility_Review", "Release Processing");
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "'Eligibility Review' link is clicked and 'Release Processing' landing page is verified successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
