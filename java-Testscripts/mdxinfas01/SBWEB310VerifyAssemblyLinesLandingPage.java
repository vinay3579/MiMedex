...
public class SBWEB310VerifyAssemblyLinesLandingPage extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB310VerifyAssemblyLinesLandingPage.class);
    ...
    public void run() throws Exception {
		...
		// ########################################################################################################
		// # Test Case ID: SBWEB-310
		// # Test Case Name: VerifyAssemblyLinesLandingPage
		// #-------------------------------------------------------------------------------------------------------
		// # Description: This scripts verifies that a the user can sign in and land on the "Assembly Lines" landing page and then successfully log out.
		// #-------------------------------------------------------------------------------------------------------
