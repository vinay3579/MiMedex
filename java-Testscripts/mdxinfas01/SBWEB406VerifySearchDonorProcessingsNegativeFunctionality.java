...
public class SBWEB406VerifySearchDonorProcessingsNegativeFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB406VerifySearchDonorProcessingsNegativeFunctionality.class);
    ...
    public void run() throws Exception {
		...
		// # Test Case Name: VerifyDonorProcessingsNegativeFunctionality
		// #-------------------------------------------------------------------------------------------------------
		...
		blnFlag = verifySearchResults("pgeDonorProcessing", "Donor", strSearchText, "pgeCommon", "objNoRecordsFound", strExpectedText);
		...
		blnFlag = clearSearchField("pgeDonorProcessing", "Donor");
		...
		// ########################################################################################################
		// Step 7 - Enter some invalid/junk characters in the 'Recovery ID' search box and verify displayed message. 
		// ########################################################################################################
		...
		blnFlag = verifySearchResults("pgeDonorProcessing", "Recovery ID", strSearchText, "pgeCommon", "objNoRecordsFound", strExpectedText);
		...
		// ########################################################################################################
		// Step 8 - Clear 'Recovery ID' search box and verify page refresh. 
		// ########################################################################################################
		...
		blnFlag = clearSearchField("pgeDonorProcessing", "Recovery ID");
		...
		// ########################################################################################################
		// Step 9 - Enter some invalid/junk characters in the 'Received Date' search box and verify displayed message. 
		// ########################################################################################################
		strStepDesc = "Enter some invalid/junk characters in the 'Received Date' search box.";
		strExpResult = "Invalid/junk characters should be entered in the 'Received Date' search box and '" + strExpectedText + "' message should be displayed.";
		blnFlag = verifySearchResults("pgeDonorProcessing", "Received Date", strSearchText, "pgeCommon", "objNoRecordsFound", strExpectedText);
		
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "Invalid/junk characters are entered in the 'Received Date' search box and '" + strExpectedText + "' message is displayed successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		// ########################################################################################################
		// Step 10 - Clear 'Received Date' search box and verify page refresh. 
		// ########################################################################################################
		strStepDesc = "Clear 'Received Date' search box and verify page refresh.";
		strExpResult = "'Received Date' search box should be cleared and the page should be refreshed.";
		blnFlag = clearSearchField("pgeDonorProcessing", "Received Date");
		...
		// ########################################################################################################
		// Step 11 - Enter some invalid/junk characters in the 'Processing Started' search box and verify displayed message. 
		// ########################################################################################################
		strStepDesc = "Enter some invalid/junk characters in the 'Processing Started' search box.";
		...
		blnFlag = verifySearchResults("pgeDonorProcessing", "Processing Started", strSearchText, "pgeCommon", "objNoRecordsFound", strExpectedText);
		...
		// ########################################################################################################
		// Step 12 - Clear 'Processing Started' search box and verify page refresh. 
		// ########################################################################################################
		...
		blnFlag = clearSearchField("pgeDonorProcessing", "Processing Started");
		...
		// ########################################################################################################
		// Step 13 - Enter some invalid/junk characters in the 'Processing Ended' search box and verify displayed message. 
		// ########################################################################################################
		strStepDesc = "Enter some invalid/junk characters in the 'Processing Ended' search box.";
		...
		blnFlag = verifySearchResults("pgeDonorProcessing", "Processing Ended", strSearchText, "pgeCommon", "objNoRecordsFound", strExpectedText);
		...
		// ########################################################################################################
		// Step 14 - Clear 'Processing Ended' search box and verify page refresh. 
		// ########################################################################################################
		...
		blnFlag = clearSearchField("pgeDonorProcessing", "Processing Ended");
		...
		// ########################################################################################################
		// Step 15 - Enter some invalid/junk characters in the 'Open WO?' search box and verify displayed message. 
		// ########################################################################################################
		strStepDesc = "Enter some invalid/junk characters in the 'Open WO?' search box.";
		strExpResult = "Invalid/junk characters should be entered in the 'Open WO?' search box and '" + strExpectedText + "' message should be displayed.";
		blnFlag = verifySearchResults("pgeDonorProcessing", "Open WO?", strSearchText, "pgeCommon", "objNoRecordsFound", strExpectedText);
		
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "Invalid/junk characters are entered in the 'Open WO?' search box and '" + strExpectedText + "' message is displayed successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		// ########################################################################################################
		// Step 16 - Clear 'Open WO?' search box and verify page refresh. 
		// ########################################################################################################
		strStepDesc = "Clear 'Open WO?' search box and verify page refresh.";
		strExpResult = "'Open WO?' search box should be cleared and the page should be refreshed.";
		blnFlag = clearSearchField("pgeDonorProcessing", "Open WO?");
