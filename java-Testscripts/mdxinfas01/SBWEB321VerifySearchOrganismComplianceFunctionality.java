...
public class SBWEB321VerifySearchOrganismComplianceFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB321VerifySearchOrganismComplianceFunctionality.class);
    ...
    public void run() throws Exception {
		...
		// # landing page, search for an Organism and then successfully log out.
		// #-------------------------------------------------------------------------------------------------------
		...
		// ########################################################################################################
		strStepDesc = "Click on 'Organism Compliance' link and verify 'Lab Test Rejections' page is displayed.";
		...
		//########################################################################################################
		//Step 5 - 	Verify that if search functionality working properly in Organism Compliance grid.
		//########################################################################################################
		strStepDesc = "Verify search functionality working properly in 'Organism Compliance' grid.";
		strExpResult = "Searched result should be displayed in the 'Organism Compliance' grid.";
		blnFlag=verifySearch("pgeOrganismCompliance","txtOrganismName","lnkOrganismName", strOrganismName);
		if (blnFlag == true)
		{
			reporter.ReportStep(strStepDesc, strExpResult, "Search functionality working properly in Organism Compliance grid in the Organism Name field with value '"+strOrganismName+"'.", "Pass");
		}
		else
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
