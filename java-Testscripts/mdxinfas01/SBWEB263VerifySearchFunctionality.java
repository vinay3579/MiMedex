...
public class SBWEB263VerifySearchFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB263VerifySearchFunctionality.class);
