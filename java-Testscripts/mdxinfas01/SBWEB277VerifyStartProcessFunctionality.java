...
public class SBWEB277VerifyStartProcessFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB277VerifyStartProcessFunctionality.class);
