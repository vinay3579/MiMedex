...
public class SBWEB237VerifySterilizationVendorsLandingPage extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB237VerifySterilizationVendorsLandingPage.class);
    ...
    public void run() throws Exception {
		...
		// ########################################################################################################
		// # Test Case ID: SBWEB-237
		// # Test Case Name: VerifySterilizationVendorsLandingPage
		// #------------------------------------------------------------------------------------------------------
		// # Description: This scripts verifies that the user can sign up and reach to the Sterilization Vendors 
		...
		// ########################################################################################################
		// Step 4 - Click on 'Sterilization' link and verify landing page.
		// ########################################################################################################
		strStepDesc = "Click on 'Sterilization' link and verify 'Sterilization Vendors' landing page is displayed.";
		strExpResult = "'Sterilization Vendors' landing page should be displayed.";
		blnFlag=clickAndVerify("pgeAssembly_Lines","lnkSterilization", "Sterilization Vendors");
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "'Sterilization' link is clicked and 'Sterilization Vendors' landing page is verified successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
