...
public class SBWEB392VerifyTransferOrderFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB392VerifyTransferOrderFunctionality.class);
