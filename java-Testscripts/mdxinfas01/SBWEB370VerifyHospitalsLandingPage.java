...
public class SBWEB370VerifyHospitalsLandingPage extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB370VerifyHospitalsLandingPage.class);
    ...
    public void run() throws Exception {
		...
		// ########################################################################################################
		// # Test Case ID: SBWEB-370
		// # Test Case Name: VerifyHospitalsLandingPage
		// #-------------------------------------------------------------------------------------------------------
		...
		// ########################################################################################################
		// Step 4 - Click on 'Hospitals' link and verify landing page.
		// ########################################################################################################
		strStepDesc = "Click on 'Hospitals' link and verify 'Hospitals' landing page is displayed.";
		strExpResult = "'Hospitals' landing page should be displayed.";
		blnFlag=clickAndVerify("pgeAssembly_Lines","lnkHospitals", "Hospitals");
		
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, " 'Hospitals' link is clicked and 'Hospitals' landing page is verified successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
