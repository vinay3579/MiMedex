...
public class SBWEB365VerifyCSectionScheduleLandingPage extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB365VerifyCSectionScheduleLandingPage.class);
    ...
    public void run() throws Exception {
		...
		// ########################################################################################################
		// # Test Case ID: SBWEB-365
		// # Test Case Name: VerifyCSectionScheduleLandingPage
		// #-------------------------------------------------------------------------------------------------------
		...
		// ########################################################################################################
		// Step 4 - Click on 'C-Section Schedule' link and verify landing page.
		// ########################################################################################################
		strStepDesc = "Click on 'C-Section Schedule' link and verify 'C-Section Schedule' landing page is displayed.";
		strExpResult = "'C-Section Schedule' landing page should be displayed.";
		blnFlag=clickAndVerify("pgeAssembly_Lines","lnkC_Section_Schedule", "C-Section Schedule");
		
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, " 'C-Section Schedule' link is clicked and 'C-Section Schedule' landing page is verified successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
