...
public class SBWEB278VerifyTissueAssmt extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB278VerifyTissueAssmt.class);
    ...
    public void run() throws Exception {
		...
		String strPerformedBy = Script.dicTestData.get("strPerformedBy");
		...
		//########################################################################################################
		//Step 13 -   Sign the canvas and provide electronic signature.
		//########################################################################################################
		strStepDesc = "Sign the canvas and provide electronic signature.";
		strExpResult = "The Tissue Assessment form should be signed successfully.";		
		blnFlag=electronicSignatureTissueAssessment(strUserName,strPassword);
		if (blnFlag == true)
		{
			reporter.ReportStep(strStepDesc, strExpResult, "The Tissue Assessment form has been signed successfully", "Pass");
		}
		else
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		//########################################################################################################
		//Step 14 -   Select value from the 'Performed By' dropdown.
		//########################################################################################################
		strStepDesc = "Select value from the 'Performed By' dropdown.";
		strExpResult = "The value '" +strPerformedBy +"' should be selected from 'Performed By' dropdown.";		
		blnFlag = Page("pgeRawTissueAssessment").Element("lstPerformedBy").Select(strPerformedBy);
		if (blnFlag == true)
		{
			reporter.ReportStep(strStepDesc, strExpResult, "The value '" +strPerformedBy +"' has been selected from 'Performed By' dropdown successfully.", "Pass");
		}
		else
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		//########################################################################################################
		//Step 15 -   Click on 'Save' button and verify Raw Tissue Assessment page fields are locked.
		//########################################################################################################
		strStepDesc = "Click on 'Save' button and verify Raw Tissue Assessment page fields are locked.";
		strExpResult = "The 'Save' button should be clicked and the values should be locked.";		
		blnFlag=clickAndVerify("pgeRawTissueAssessment", "btnSave", "pgeRawTissueAssessment", "btnUnlock");
		if (blnFlag == true)
		{
			reporter.ReportStep(strStepDesc, strExpResult, "The 'Save' button is clicked and the values are locked successfully.", "Pass");
		}
		else
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
		...
		//########################################################################################################
		//Step 16 - 	Verify 'Print Nalgene Labels' on 'Raw Tissue Assessment' page.
		//########################################################################################################
		...
		//########################################################################################################
		//Step 17 - 	 Close the 'Print Nalgene Labels' PDF and validate if the PDF has been closed successfully.
		//########################################################################################################
		...
		//########################################################################################################
		//Step 18 - 	Verify 'Print Assessment Form' on 'Raw Tissue Assessment' page.
		//########################################################################################################
		...
		//########################################################################################################
		//Step 19 - 	 Close the 'Print Assessment Form' PDF and validate if the PDF has been closed successfully.
		//########################################################################################################
		...
		//########################################################################################################
		//Step 20 -   Click on 'Return' button and verify Donor Tissues page.
		//########################################################################################################
