...
public class SBWEB245VerifyOpenSalesShipOrdersLandingPage extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB245VerifyOpenSalesShipOrdersLandingPage.class);
    ...
    public void run() throws Exception {
		...
		// ########################################################################################################
		// # Test Case ID: SBWEB-245
		// # Test Case Name: VerifyOpenSalesShipOrdersLandingPage
		// #-------------------------------------------------------------------------------------------------------
		...
		// ########################################################################################################
		// Step 4 - Click on 'Shipping' link and verify landing page.
		// ########################################################################################################
		strStepDesc = "Click on 'Shipping' link and verify 'Open Sales/Ship Orders' landing page is displayed.";
		strExpResult = "'Open Sales/Ship Orders' landing page should be displayed.";
		blnFlag=clickAndVerify("pgeAssembly_Lines","lnkShipping", "Open Sales/Ship Orders");
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "'Shipping' link is clicked and 'Open Sales/Ship Orders' landing page is verified successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
