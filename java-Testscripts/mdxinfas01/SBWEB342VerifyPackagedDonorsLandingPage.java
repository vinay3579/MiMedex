...
public class SBWEB342VerifyPackagedDonorsLandingPage extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB342VerifyPackagedDonorsLandingPage.class);
    ...
    public void run() throws Exception {
		...
		// ########################################################################################################
		// # Test Case ID: SBWEB-342
		// # Test Case Name: VerifyPackagedDonorsLandingPage
		// #-------------------------------------------------------------------------------------------------------
		// # Description: This scripts verifies that a the user can sign in and land on the "Packaged Donors" landing page and then successfully log out.
		// #-------------------------------------------------------------------------------------------------------
		...
		// ########################################################################################################
		// Step 4 - Click on 'Packaged Donors' link and verify 'Packaged Donors' landing page is displayed.
		// ########################################################################################################
		strStepDesc = "Click on 'Packaged Donors' link and verify 'Packaged Donors' landing page is displayed.";
		strExpResult = "'Packaged Donors' landing page should be displayed.";
		blnFlag=clickAndVerify("pgeAssembly_Lines", "lnkPackagedDonors", "Packaged Donors");		
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "'Packaged Donors' link is clicked and 'Packaged Donors' landing page is verified successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
