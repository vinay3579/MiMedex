...
public class SBWEB503VerifyArdemTURsPage extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB503VerifyArdemTURsPage.class);
    ...
    public void run() throws Exception {
		...
		// #------------------------------------------------------------------------------------------------------
		// # Description: This scripts verifies that the user can sign up and reach to the Ardem TUR's landing 
		// #  page and search some tissue id on the page then successfully log out.
		// #------------------------------------------------------------------------------------------------------
		// # Pre-conditions: User is logged in into the MiMedx SBWeb application.
		// # 				 User is on "Ardem TUR's" landing page.
		// # Post-conditions: NA
		// # landing page.
		// # Limitations: NA
		// #------------------------------------------------------------------------------------------------------
		...
		String strTissueId = Script.dicTestData.get("strTissueId");
