...
public class SBWEB493VerifyEditAutoclaveLogFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB493VerifyEditAutoclaveLogFunctionality.class);
    ...
    public void run() throws Exception {
		...
		if (blnFlag == true)
		{
			reporter.ReportStep(strStepDesc, strExpResult, "A sample PDF for 'Scanned Report' should be uploaded successfully.", "Pass");
		}
		else
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");					
...
//			driver.findElement(By.xpath("//input[@id='rform:file_input']")).click();
			// driver.findElement(By.xpath("//input[contains(@id,'rform') and @type='file']")).click();
//			driver.findElement(By.xpath("//div[@id='rform:file']//span")).click();
			// blnFlag=Page("pgeRelease_Processing").Element("//div[@id='rform:file']//span").Exist();
			blnFlag=Page("pgeRelease_Processing").Element("//div[@class='ui-fileupload ui-widget']//span").Exist();
			if(blnFlag)
			{
				// blnFlag=Page("pgeRelease_Processing").Element("//div[@id='rform:file']//span").Click(20);
