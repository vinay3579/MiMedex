...
public class SBWEB318VerifySearchLabTestRejectionsFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB318VerifySearchLabTestRejectionsFunctionality.class);
    ...
    public void run() throws Exception {
		...
		// ########################################################################################################
		// # Test Case ID: SBWEB-318
		// # Test Case Name: VerifySearchLabTestRejectionsFunctionality
		// #-------------------------------------------------------------------------------------------------------
		// # Description: This scripts verifies that the user can sign up and reach to the Lab Test Rejections
		// # landing page, search for a Donor Key and then successfully log out.
		// #-------------------------------------------------------------------------------------------------------
		...
		//########################################################################################################
		//Step 5 - 	Verify that if search functionality working properly in Lab Test Rejections grid.
		//########################################################################################################
		strStepDesc = "Verify search functionality working properly in 'Lab Test Rejections' grid.";
		strExpResult = "Searched result should be displayed in the 'Lab Test Rejections' grid.";
		blnFlag=verifySearch("pgeLabTestRejections","txtDonor","lnkDonor", strDonorKey);
		if (blnFlag == true)
		{
			reporter.ReportStep(strStepDesc, strExpResult, "Search functionality working properly in Lab Test Rejections grid in the Donor Key field with value '"+strDonorKey+"'.", "Pass");
		}
		else
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
