...
public class SBWEB368VerifyPrintCurrentScheduleLinkFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB368VerifyPrintCurrentScheduleLinkFunctionality.class);
