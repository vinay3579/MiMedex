...
public class SBWEB389VerifyPrintReportAndPrintBillingFunctionality extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB389VerifyPrintReportAndPrintBillingFunctionality.class);
