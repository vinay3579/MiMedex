...
public class SBWEB384VerifyConsignmentBillingLandingPage extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB384VerifyConsignmentBillingLandingPage.class);
    ...
    public void run() throws Exception {
		...
		// ########################################################################################################
		// # Test Case ID: SBWEB-384
		// # Test Case Name: VerifyConsignmentBillingLandingPage
		// #-------------------------------------------------------------------------------------------------------
		...
		// ########################################################################################################
		// Step 4 - Click on 'Consignment Billing' link and verify landing page.
		// ########################################################################################################
		strStepDesc = "Click on 'Consignment Billing' link and verify 'Consignment Billing' landing page is displayed.";
		strExpResult = "'Consignment Billing' landing page should be displayed.";
		blnFlag=clickAndVerify("pgeAssembly_Lines","lnkConsignmentBilling", "Consignment Billing");
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "'Consignment Billing' link is clicked and 'Consignment Billing' landing page is verified successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
