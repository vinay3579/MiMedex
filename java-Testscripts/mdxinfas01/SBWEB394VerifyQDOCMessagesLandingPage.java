...
public class SBWEB394VerifyQDOCMessagesLandingPage extends Script {
	private static final Logger logger = Logger.getLogger(SBWEB394VerifyQDOCMessagesLandingPage.class);
    ...
    public void run() throws Exception {
		...
		// ########################################################################################################
		// # Test Case ID: SBWEB-394
		// # Test Case Name: VerifyQDOCMessagesLandingPage
		// #-------------------------------------------------------------------------------------------------------
		...
		// ########################################################################################################
		// Step 4 - Click on 'QDOC Messages' link and verify landing page.
		// ########################################################################################################
		strStepDesc = "Click on 'QDOC Messages' link and verify 'View QDOC Messages' landing page is displayed.";
		strExpResult = "'View QDOC Messages' landing page should be displayed.";
		blnFlag=clickAndVerify("pgeAssembly_Lines","lnkQDOCMessages", "View QDOC Messages");
		if (blnFlag == true) 
		{
			reporter.ReportStep(strStepDesc, strExpResult, "'QDOC Messages' link is clicked and 'View QDOC Messages' landing page is verified successfully.", "Pass");
		}
		else 
		{
			reporter.ReportStep(strStepDesc, strExpResult, Err.Description, "Fail");
